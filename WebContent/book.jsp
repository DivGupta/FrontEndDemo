...
<body style="text-align: center">
	...
	<div class="container-fullwidth">
		...
		<form action="books" method="post">
							...
							<c:set var="cov" scope="session" value="${cover}"/>
			...
			<div class="stars">
				...
				<p>Comment:</p>
				<textarea style="height: 150px; width: 300px;"
					placeholder="Comment Here" name="text"></textarea>
				<br>
			...
			<div>
				...
				<c:forEach items="${book.getBookComments()}" var = "comment">

				<p>
					Author:
					${comment.getUsername().getName()}
				</p>
				<p>
					Rating:
					${comment.getRating()}
